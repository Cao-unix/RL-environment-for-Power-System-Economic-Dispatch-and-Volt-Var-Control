...
def interact_with_environment(env, replay_buffer, num_actions, state_dim, device, args, parameters):
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if (t + 1) % parameters["eval_freq"] == 0:
            eval_reward = eval_policy(policy, args.env, args.case, args.seed,1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default="DiscreteVoltVarPowerflow-v1")
    # Case name
    parser.add_argument("--case", default="case5bw")
    ...
    logdir = os.path.join("./data/results/optional3", run_name)
